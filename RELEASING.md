...
1. **Bump version** in three places:
   ...
   - `src/simdeck/ui/constants.py` → `__version__ = "X.X.X"`
...
3. **Commit and push:**
   ```
   git add src/simdeck/__init__.py src/simdeck/ui/constants.py packaging/windows/installer.iss CHANGELOG.md README.md
